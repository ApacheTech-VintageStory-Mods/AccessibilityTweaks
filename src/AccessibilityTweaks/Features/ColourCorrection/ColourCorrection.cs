using AccessibilityTweaks.Features.ColourCorrection.Dialogue;
using AccessibilityTweaks.Features.ColourCorrection.Shaders;
...
/// </summary>
public sealed class ColourCorrection : ClientModSystem<ColourCorrection>, IClientServiceRegistrar
{
    ...
    public override void StartClientSide(ICoreClientAPI capi)
    {
        ...
        _renderer = G.Services.Resolve<ColourCorrectionRenderer>();
    ...
    {
        var shader = G.Services.CreateInstance<ColourCorrectionShaderProgram>();
    ...
    public override void Dispose()
    {
        ...
        _capi.ReloadShadersThreadSafe(Core);
        _renderer?.Dispose();
        base.Dispose();
    }
}